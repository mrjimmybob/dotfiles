...
local DEFAULT_OPACITY = 0.90 -- opacity used at startup
...
config.window_frame = {
	...
	font_size = 11,
	active_titlebar_bg = "#1e1e2e", -- #0c0b0f
}
...
config.keys = {
 ...
 --tmux- { key = "p",  mods = "LEADER",         action = wezterm.action.ActivatePaneDirection("Prev") },
 --tmux- { key = "n",  mods = "LEADER",         action = wezterm.action.ActivatePaneDirection("Next") },
 --tmux- { key = "h",  mods = "LEADER",         action = wezterm.action.ActivatePaneDirection("Left") },
 --tmux- { key = "j",  mods = "LEADER",         action = wezterm.action.ActivatePaneDirection("Down") },
 --tmux- { key = "k",  mods = "LEADER",         action = wezterm.action.ActivatePaneDirection("Up") },
 --tmux- { key = "l",  mods = "LEADER",         action = wezterm.action.ActivatePaneDirection("Right") },
 --tmux- { key = "h",  mods = "LEADER|CTRL",    action = wezterm.action.AdjustPaneSize({ "Left", 5 }) },
 --tmux- { key = "j",  mods = "LEADER|CTRL",    action = wezterm.action.AdjustPaneSize({ "Down", 5 }) },
 --tmux- { key = "k",  mods = "LEADER|CTRL",    action = wezterm.action.AdjustPaneSize({ "Up", 5 }) },
 --tmux- { key = "l",  mods = "LEADER|CTRL",    action = wezterm.action.AdjustPaneSize({ "Right", 5 }) },
...
--tmux-	{ key = "\\", mods = "LEADER",         action = wezterm.action.SplitHorizontal({ domain = "CurrentPaneDomain" }) },
--tmux-	{ key = "-",  mods = "LEADER",         action = wezterm.action.SplitVertical({ domain = "CurrentPaneDomain" }) },
...
--	{ key = "v",  mods = "LEADER",         action = wezterm.action.SplitPane({ direction = "Right", size = { Percent = 50 } }), },
 --tmux- { key = "[",  mods = "LEADER",         action = wezterm.action.ActivateTabRelative(-1) },

 --tmux- { key = "]",  mods = "LEADER",         action = wezterm.action.ActivateTabRelative(1) },
 --tmux- { key = "{",  mods = "LEADER|SHIFT",   action = wezterm.action.MoveTabRelative(-1) },

 --tmux- { key = "}",  mods = "LEADER|SHIFT",   action = wezterm.action.MoveTabRelative(1) },
	{ key = "s",  mods = "LEADER",         action = wezterm.action.PaneSelect },
--tmux-{ key = "z",  mods = "LEADER",         action = wezterm.action.TogglePaneZoomState },
	--tmux-{ key = "t",  mods = "LEADER",         action = wezterm.action.SpawnTab("CurrentPaneDomain") },
--	{ key = 'n',  mods = 'LEADER',     action = wezterm.action.SpawnWindow },
	--tmux-{ key = "1",  mods = "LEADER",         action = wezterm.action({ ActivateTab = 0 }) },
	--tmux-{ key = "2",  mods = "LEADER",         action = wezterm.action({ ActivateTab = 1 }) },
	--tmux-{ key = "3",  mods = "LEADER",         action = wezterm.action({ ActivateTab = 2 }) },
	--tmux-{ key = "4",  mods = "LEADER",         action = wezterm.action({ ActivateTab = 3 }) },
	--tmux-{ key = "5",  mods = "LEADER",         action = wezterm.action({ ActivateTab = 4 }) },
	--tmux-{ key = "6",  mods = "LEADER",         action = wezterm.action({ ActivateTab = 5 }) },
	--tmux-{ key = "7",  mods = "LEADER",         action = wezterm.action({ ActivateTab = 6 }) },
	--tmux-{ key = "8",  mods = "LEADER",         action = wezterm.action({ ActivateTab = 7 }) },
	--tmux-{ key = "9",  mods = "LEADER",         action = wezterm.action({ ActivateTab = 8 }) },
