...
# swww img "$IMG" --transition-type wipe --transition-fps 60 --transition-duration 1
swww img "$IMG" --transition-type random --transition-pos 0.5,0.5 --transition-duration 1 --transition-fps 60
